...
END;
	...
	function metabox_informacion_recurso($post){
		...
		//$diaHora 		= get_post_meta($post->ID, '_dia_hora_recurso_meta', true);
		$web 			= get_post_meta($post->ID, '_web_recurso_meta', true);
		$email 			= get_post_meta($post->ID, '_email_recurso_meta', true);
		$eventoFacebook = get_post_meta($post->ID, '_evento_facebook_recurso_meta', true);
		...
		//wp_nonce_field(__FILE__, '_dia_hora_recurso_meta');
		wp_nonce_field(__FILE__, '_web_recurso_meta');
		wp_nonce_field(__FILE__, '_email_recurso_meta');
		wp_nonce_field(__FILE__, '_evento_facebook_recurso_meta');
...
echo <<<END
	...
	<label>Día:</label>
	<input type="text" class="widefat j-datetimepicker" id="dia" name="_dia_hora_recurso_meta" value="$diaHora" /><br/><br/>
	...
	<label>Evento en facebook:</label>
	<input type="text" class="widefat" id="evento_facebook" name="_evento_facebook_recurso_meta" value="$eventoFacebook" />
