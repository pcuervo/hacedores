			...
			if (count($images)) {
				...
				<div class="[ clearfix ] [ margin-bottom-medium ]">
					...
					for ($i=0;$i<count($thumbs);$i++) {
						...
						$gall .= '<li class="[ columna xmall-6 medium-4 ]">
							<a class="[ ]" data-imagelightbox="f" href="'.$image[0].'"'.(($gallery_type == 'lightbox_labeled')?' title="'.$thumb[5].'"':'').' data-id="'.$image[4].'" data-number="'.$i.'" rel="gallery-'.$gallid.'"><img class="[ ] attachment-thumbnail" src="'.$thumb[0].'" /></a>';
